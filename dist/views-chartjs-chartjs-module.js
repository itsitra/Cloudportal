...
var ChartJSComponent = /** @class */ (function () {
    ...
    ChartJSComponent.prototype.upadateLineChartData = function () {
        var _this = this;
        var lineData = [];
        ...
        setInterval(function () {
            ...
            //lineData.push(sno++)
            _this.lineChartData[0].data.push(sno);
            //  this.lineChartData[1].data.push(snoo);
            _this.lineChartLabels.push(datetime.getHours() + ':' + datetime.getMinutes() + ':' + datetime.getSeconds());
