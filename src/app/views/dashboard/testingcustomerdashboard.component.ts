...
@Component({
  ...
  templateUrl: './testingcustomerdashboard.component.html',
  styleUrls: ['./testingcustomerdashboard.component.css']
})
export class TestingcustomerdashboardComponent implements OnInit {
  ...
  async getData() {
    ...
    await this.http.post<any>('http://192.168.1.7:82/cloudwallet/index.php/api/get_testing_charges/' + this.deptid, { data : this.apiParams }).subscribe({
      next: data => {
